...
@media (max-width: 992px) {
    ...
    /* Hide the big avatar box on mobile to save space */
    ...
    /* Arrange actions (icons) in a row */
    .header-actions-group {
        width: 100%;
        justify-content: space-around;
    }
    
    /* Hide text labels for actions on very small screens, keep icons */
    .action-item span {
        display: none;
    }
    .action-item svg {
    ...
    /* Rearrange Order: Card first, buttons below */
    #q-card { order: 1; margin-bottom: 15px; width: 100%; height: auto; min-height: 50vh; }
    #btn-prev { order: 2; width: 48%; float: left; }
    #btn-next { order: 3; width: 48%; float: right; margin-left: 4%; }
    
    /* Fix Navigation Circle Size */
    .nav-circle {
        width: 36px;
        height: 36px;
        margin-right: 10px;
    ...
    .nav-text br { display: none; } /* One line text */

    /* --- 4. Question Card Internals --- */
    .q-card {
        flex-direction: column; /* Stack sidebar and content */
        overflow: visible; /* Allow scrolling page instead of inner div */
        height: auto;
    }

    /* Top bar for question number */
    .q-num-col {
        width: 100%;
        height: 50px;
        flex-direction: row;
    ...
    /* --- 5. Split View (Type B Questions) --- */
    .layout-split {
        flex-direction: column; /* Paragraph on top, Question below */
    }
    .split-left-pane {
        height: 250px; /* Fixed height for paragraph area */
        border-right: none;
    ...
    .split-right-pane .q-body {
        padding: 20px;
    }
    /* Hide duplicate sidebar in split view (since we moved it) */
    .split-right-pane .q-num-col {
        display: none; 
    }
    ...
    .settings-panel {
        width: 100%; /* Full screen settings on mobile */
        right: -100%;
    }
